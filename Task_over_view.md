...
## Objectives
Build application with main features to help users search and connect.
...
### [ ] Version 1.1: Post-Launch Enhancements - `Todo`
    - [ ] Phase 01: Bug Fixes From V1.0 - `Todo` -> [Link to directory](./V1.1_Post_Launch_Enhancements/01_Bug_Fixes_From_V1.0/)
    - ...
